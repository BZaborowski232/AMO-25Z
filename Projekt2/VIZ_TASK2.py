...
ax.set_ylabel('$x_2$')
ax.set_zlabel('$f(x)$')
ax.set_title('Funkcja celu 3D (2 ograniczenia)')
...
x2_line1 = 1 - x1_line
ax2.plot(x1_line, x2_line1, 'r--', label='x1 + x2 = 1')

# x1 - x2 = 0
x2_line2 = x1_line
ax2.plot(x1_line, x2_line2, 'b--', label='x1 - x2 = 0')

ax2.set_xlabel('$x_1$')
ax2.set_ylabel('$x_2$')
ax2.set_title('Poziomice funkcji celu z ograniczeniami')
ax2.legend()
